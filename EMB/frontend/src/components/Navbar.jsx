  ...
  return (
    <nav className="w-full h-[67px] bg-[#EEF1F8] flex items-center justify-between px-8 fixed top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="font-inter font-bold text-lg leading-tight text-helix-navy">Helix</h1>
          <p className="text-[10px] text-helix-gray-700 font-medium">From Tech Wizard</p>
        </div>
      </div>
